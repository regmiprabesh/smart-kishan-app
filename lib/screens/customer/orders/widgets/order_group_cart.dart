...
import 'package:smart_kishan/screens/customer/orders/order_details_screen.dart';
          ...
          Expanded(
            child: Row(
              children: [
                ...
                Flexible(
                  child: Text(
                    '${order.vendor != null ? order.vendor!.name : AppLocalizations.of(context)!.vendorNotAvailable}',
