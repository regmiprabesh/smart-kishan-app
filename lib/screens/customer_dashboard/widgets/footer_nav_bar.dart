...
class CustomerFooterNavBar extends StatelessWidget {
  final Color? backgroundColor;
  final List<FooterBottomBarItems?> customBottomBarItems;
        ...
        child: Row(
          ...
          children: [
            for (int i = 0; i < customBottomBarItems.length; i++) ...[
              customBottomBarItems[i] != null
                  ? Expanded(
                      child: CustomerFooterNavBarItems(
...
class CustomerFooterNavBarItems extends StatelessWidget {
  final List<List<dynamic>>? icon;
  final String? label;
  final Color? selectedColor;
  final Color? unSelectedColor;
